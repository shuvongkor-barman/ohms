			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<a href="../index.html"> <h1 class="text-center text-bold text-light mt-4x" id="titleOfApp">DIU HMS v1.0</h1> </a>
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="submit" name="login" class="btn btn-primary btn-block" value="login" style="font-size: 1.5em;>
								</form>
							</div>
						</div>
					</div>
...
<p> Forgot Password! Contact <a href="#">DIU HMS Super Admin</a></p>
</footer> </div>
